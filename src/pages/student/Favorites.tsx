...
const Favorites = () => {
  ...
  const handleRemoveFavorite = (id: string) => {
    ...
    toast({
      title: "Teacher removed from favorites",
    });
  };
  ...
  return (
    <div className="space-y-6">
      ...
      >
        ...
        <p className="text-muted-foreground">Your collection of favorite teachers for quick access.</p>
      </motion.div>
      
      {favorites.length === 0 ? (
        <div className="text-center py-16">
          <Heart className="h-16 w-16 mx-auto text-muted-foreground stroke-1" />
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex gap-2">
                      ...
                      <Button size="sm" asChild>
                        <Link to={`/student/teacher/${teacher.id}`}>View</Link>
                      </Button>
                    </div>
                  </div>
                </CardContent>
